...
storage_folder = 'D:\CommonCrawlData' #'CommonCrawlData/CC-MAIN-2019-51'
...
def reporthook(count, block_size, total_size):
    ...
    speed = 300*1024#int(progress_size / (1024 * duration))
...
cc_indexes = read_every_line('CommonCrawlData/CC-MAIN-2019-51/cc-index.paths')
